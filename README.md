...
Open `http://localhost:5173` in two browser tabs. Each tab will be assigned to a different paddle automatically. Use `W`/`S` or the arrow keys to move your paddle.
